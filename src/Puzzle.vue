       ...
       props:{
        ...
        computed:{
           blockWidth(){
            ...
            blockPoints(){
                ...
                newArr.sort(function(a,b){return Math.random()-0.5});
                newArr.push(lastEle);
                console.log(newArr)
                return newArr;
            }
        ...
        methods:{
            ...
            isAdjacent(blockDom,emptyDom){
                const { left:domLeft,top:domTop ,width,height}=emptyDom.style;
                const { left:emptyLeft,top:emptyTop }=blockDom.style;
